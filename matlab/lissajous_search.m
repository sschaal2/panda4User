    ...
    for convex_beta=0.5:0.5/res:1
        for freq_ratio_rot=2.:2/res:4
            for convex_freq_ratio=0.1:0.4/res:0.5
                ...
                X=lissajous(freq_base, amplitude_slow, amplitude_fast, amplitude_rot, freq_ratio+0.011, freq_ratio_rot+0.03, convex_beta+0.0017, convex_freq_ratio+0.0037, trans_duration, duration,0);
                ...
                % test: only count occupancy: no sure that is useful
                %inds = find(h>0);
                %h(inds) = 1/length(inds);
...
lissajous(freq_base, amplitude_slow, amplitude_fast, amplitude_rot, freq_ratio, freq_ratio_rot, convex_beta, convex_freq_ratio,trans_duration,duration,1);
lissajous(freq_base, amplitude_slow, amplitude_fast, amplitude_rot, freq_ratio, freq_ratio_rot, convex_beta, convex_freq_ratio,trans_duration,2*duration,1);
